...
# Download
wget "https://github.com/Geoxor/Xornet/releases/download/v0.11/xornet-reporter-v0.11.bin" -P /etc/xornet
chmod +x /etc/xornet/xornet-reporter-v0.11.bin
echo "Xornet reporter downloaded!"

# Download service
sudo wget "https://cdn.discordapp.com/attachments/806300597338767450/842128237999554631/xornet.service" -P /etc/systemd/system
