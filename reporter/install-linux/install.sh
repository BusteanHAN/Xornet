...
# Download
wget "https://github.com/Geoxor/Xornet/releases/download/v0.12/xornet-reporter-v0.12.bin" -P /etc/xornet
chmod +x /etc/xornet/xornet-reporter-v0.12.bin
echo "Xornet reporter downloaded!"

# Download service
sudo wget "https://cdn.discordapp.com/attachments/806300597338767450/842928215507992606/xornet.service" -P /etc/systemd/system
